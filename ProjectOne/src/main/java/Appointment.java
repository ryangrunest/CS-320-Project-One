...
public class Appointment {
  ...
  private void validateAppointmentId(String appointmentId) {
    if (appointmentId == null || appointmentId.length() > 10) {
      throw new IllegalArgumentException(
          "Appointment ID must be a non-null string with a maximum length of 10 characters.");
    }
  }
  ...
  // shall not be null.
  // Note: Use java.util.Date for the appointmentDate field and use before(new
  // Date()) to check if the date is in the past.
